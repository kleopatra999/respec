/*globals define, respecEvents, require */
...
define(
  ...
  function($, shortcut) {
    ...
    var errWarn = function(msg, arr, butName, bg, title) {
      arr.push(msg);
      if (!buttons[butName]) {
